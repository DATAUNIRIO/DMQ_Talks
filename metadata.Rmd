...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">
 <a href="https://meet.google.com/xjh-fimh-zxd">meet.google.com/xjh-fimh-zxd</a> 
</span>
...
```{r,echo=FALSE}
minhasdatas <- as.Date(c("2020-07-06","2020-07-13","2020-07-20",
                         "2020-07-27"))
minhahora<-rep("14 Horas",4)
#format(minhasdatas, format="%d%m%Y")
Palestrante<-c("Felipe Ribeiro","Davi Alves","Beatriz Cunha","Steven Ross")

Link<- c("meet.google.com/uns-ycoi-bzk",
...
Link<- c("meet.google.com/wqk-fcod-eps","meet.google.com/bwt-pmee-acz","https://www.meet.google.com/axv-azca-rwq","meet.google.com/mrw-qgvc-svf","meet.google.com/cfo-zhba-oyr")
...
youtube<-c("https://youtu.be/bZl3-HJdLlo","https://youtu.be/Ai6wcDdHhmc","https://youtu.be/A42EgBiG3Zs","https://youtu.be/2bTlNeYpW1E","https://youtu.be/x_nG91PiuKI")

#estimativa_do_numero_de_pessoas<-c(23,59,20,26,50)
