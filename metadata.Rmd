...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">Prof. Bruno Simões</span>
<br>
<br>
<br>
...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">
 <a href="https://meet.google.com/cfo-zhba-oyr">meet.google.com/cfo-zhba-oyr</a> 
</span>
...
```{r,echo=FALSE}
minhasdatas <- as.Date(c("2020-06-29",
                         "2020-07-06","2020-06-13","2020-06-20",
                         "2020-06-27"))
minhahora<-rep("14 Horas",5)
#format(minhasdatas, format="%d%m%Y")
Palestrante<-c("Bruno Simões","Felipe Ribeiro"
               ,"Davi Alves","Beatriz Cunha","Steven Ross")

Link<- c("meet.google.com/xjh-fimh-zxd",
...
minhasdatas <- as.Date(c("2020-05-25"
                         ,"2020-06-01","2020-06-08","2020-06-15"))
#                         "2020-06-22","2020-06-29",
#                         "2020-07-06","2020-06-13","2020-06-20",
#                         "2020-06-27"))
minhahora<-rep("14 Horas",4)
#format(minhasdatas, format="%d%m%Y")
...
Titulo<- c("Perspectivas para nossa vida pessoal e acadêmica pós pandemia", "Práticas didático-pedagógicas e a formação de professores para o exercício responsável da docência online","Educação Estatística na promoção do engajamento cívico","O Pandemônio da Pandemia")

Link<- c("meet.google.com/wqk-fcod-eps","meet.google.com/bwt-pmee-acz","https://www.meet.google.com/axv-azca-rwq","meet.google.com/mrw-qgvc-svf")
...
youtube<-c("https://youtu.be/bZl3-HJdLlo","https://youtu.be/Ai6wcDdHhmc","https://youtu.be/A42EgBiG3Zs",NA)

#estimativa_do_numero_de_pessoas<-c(23,60,20,26)
