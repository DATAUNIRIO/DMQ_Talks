...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">Google Meet, Probabilidade e R (não necessariamente nesta ordem): um pouco da minha quarentena</span>

<br>

## Resumo

<span style=" font-size: 20px; font-weight:bold;text-align: justify;color:darkblue;">Após suspensão do calendário acadêmico 2020, grande parte dos docentes voltou-se exclusivamente às suas tarefas "fora de sala de aula", incluindo atividades de pesquisa, extensão, gestão e, até mesmo, de ensino, dentro das limitações impostas pelo distanciamento social. Neste encontro, compartilharei algumas das atividades acadêmicas que venho desenvolvendo durante a quarentena, como orientação de TCC's, elaboração de questionário para projeto de pesquisa, experiência com a ferramenta Google Meet e ilustrações que podem ser úteis em aulas de Probabilidade. E tudo isto com participação do software R.</span>
<br> 
...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">Prof. Felipe Ribeiro Melo</span>
<br>
<br>
<br>
...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">
 <a href="https://meet.google.com/uns-ycoi-bzk">meet.google.com/uns-ycoi-bzk</a> 
</span>
...
```{r,echo=FALSE}
minhasdatas <- as.Date(c("2020-07-13","2020-07-20","2020-07-27"))
minhahora<-rep("14 Horas",3)
#format(minhasdatas, format="%d%m%Y")
Palestrante<-c("Davi Alves","Beatriz Cunha","Steven Ross")

Link<- c("meet.google.com/adf-ftxf-idn",
...
```{r,echo=FALSE}
minhasdatas <- as.Date(c("2020-05-25","2020-06-01","2020-06-08","2020-06-15",
                         "2020-06-22","2020-07-29"))
#                         "2020-07-06","2020-06-13","2020-06-20",
#                         "2020-06-27"))
Palestrante<-c("Tereza Barbosa","Pimentel/Vinicius","Alexandre Silva"
              ,"Luciane Velasque","Letícia Raposo","Bruno Simões")
#,"Felipe Ribeiro","Davi Alves",
#               "Beatriz Cunha","Steven Ross")

Titulo<- c("Perspectivas para nossa vida pessoal e acadêmica pós pandemia", "Práticas didático-pedagógicas e a formação de professores para o exercício responsável da docência online","Educação Estatística na promoção do engajamento cívico","O Pandemônio da Pandemia","Atividades e Ferramentas para o Ensino Online","Projetos no ensino superior e pesquisas: ações e reflexões de um professor esperançoso")

Link<- c("meet.google.com/wqk-fcod-eps","meet.google.com/bwt-pmee-acz","https://www.meet.google.com/axv-azca-rwq","meet.google.com/mrw-qgvc-svf","meet.google.com/cfo-zhba-oyr","meet.google.com/xjh-fimh-zxd")
...
youtube<-c("https://youtu.be/bZl3-HJdLlo","https://youtu.be/Ai6wcDdHhmc","https://youtu.be/A42EgBiG3Zs","https://youtu.be/2bTlNeYpW1E","https://youtu.be/x_nG91PiuKI",NA)

#estimativa_do_numero_de_pessoas<-c(23,59,20,26,50,26)
