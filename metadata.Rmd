...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">Meu universo paralelo: Relatos de uma professora em isolamento social</span>

<br>

## Resumo

<span style=" font-size: 20px; font-weight:bold;text-align: justify;color:darkblue;">A pandemia da Covid-19 alterou a rotina de todos. Pessoas foram obrigadas repentinamente a mudar hábitos e rotinas. Mas a orientação de ficar em casa afetou as pessoas de forma diferente: alguns conseguiram manter suas produções, outros nem tanto. Nessa palestra eu pretendo mostrar como eu usei os dados da pandemia para levar conhecimento de estatística para as pessoas das minhas redes sociais e alunos, além de mostrar os projetos que estou desenvolvendo durante o distanciamento social.</span>
<br> 
...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">Profa. Beatriz Cunha</span>
<br>
<br>
<br>
...
<span style=" font-size: 32px; font-weight:bold; color:darkblue;">
 <a href="meet.google.com/phz-tmge-tqs">meet.google.com/phz-tmge-tqs</a> 
</span>
...
```{r,echo=FALSE}
minhasdatas <- as.Date(c("2020-07-27","2020-08-03"))
minhahora<-rep("14 Horas",2)
#format(minhasdatas, format="%d%m%Y")
Palestrante<-c("Steven Ross","Vinícius Israel")

Link<- c("meet.google.com/aeu-aahe-kws",NA)
...
youtube<-c("https://youtu.be/bZl3-HJdLlo","https://youtu.be/Ai6wcDdHhmc","https://youtu.be/A42EgBiG3Zs","https://youtu.be/2bTlNeYpW1E","https://youtu.be/x_nG91PiuKI","https://youtu.be/F3thfDwArZY","https://youtu.be/ohlzTdTZqFs","https://youtu.be/zP0a6f-7OnM")

#estimativa_do_numero_de_pessoas<-c(23,59,20,26,50,26,21,19)
